...
legend.addTo(map);
// Add a control to the map that allows user to change which layers are visible.
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
  ...
  // This color determines the color of the circle based on earthquake magnitude.
  ...
  // This function returns the radius data for each of the earthquakes.
